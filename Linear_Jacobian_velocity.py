...
Jacobian_Matrix = np.vstack([L_Jacobian_Matrix, A_Jacobian_Matrix])

print(Jacobian_Matrix)


q_dot = np.array([1,0,0,0,0,0,0]).reshape(-1,1)
# print(np.shape(q_dot))
#
# print(np.shape(Jacobian_Matrix))

x = Jacobian_Matrix@q_dot
# print(x)
